...
static void instr_execute_2op() 
{
    ...
    opr_src.val=sign_ext(opr_src.val & (0xFFFFFFFF >> (32 - opr_src.data_size)),data_size);
    opr_dest.val=sign_ext(opr_dest.val & (0xFFFFFFFF >> (32 - opr_dest.data_size)),data_size);
