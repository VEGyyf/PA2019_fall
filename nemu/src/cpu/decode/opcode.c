...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x20 - 0x23*/ inv, inv, inv, inv, // __ref_mov_c2r_l, inv,  __ref_mov_r2c_l, inv,
    ...
    /* 0x44 - 0x47*/  c__ref_move_rm2r_v,  c__ref_movne_rm2r_v, inv,  c__ref_mova_rm2r_v,
    /* 0x48 - 0x4b*/  c__ref_movs_rm2r_v,  c__ref_movns_rm2r_v, inv, inv,
    /* 0x4c - 0x4f*/ inv,  c__ref_movge_rm2r_v, inv, inv,
