...
instr_func opcode_entry[256] = {
    ...
    /* 0x60 - 0x63*/ pusha, popa,inv,inv,//__ref_pusha, __ref_popa, 
    ...
    /* 0xcc - 0xcf*/ inv, int_, inv, iret,//inv, ___int_, inv, ___iret,
    ...
    /* 0xec - 0xef*/ __ref_in_b, __ref_in_v, __ref_out_b, __ref_out_v,//in_b, in_v, out_b, out_v,
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x20 - 0x23*/ mov_c2r_l, inv, mov_r2c_l, inv,//mov_c2r_l, inv, mov_r2c_l, inv,__ref_
    ...
    /* 0xec - 0xef*/ inv, inv, inv, inv,//__ref_in_b, __ref_in_v, __ref_out_b, __ref_out_v,
