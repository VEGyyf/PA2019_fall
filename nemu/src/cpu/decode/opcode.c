...
instr_func opcode_entry[256] = {
    ...
    /* 0x8c - 0x8f*/ inv, lea, __ref_mov_rm2s_w, inv,//,//__ref_mov_rm2s_w
    ...
    /* 0xe8 - 0xeb*/ call_near, jmp_near, __ref_jmp_far_imm, jmp_short,//___
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x20 - 0x23*/ __ref_mov_c2r_l, inv, __ref_mov_r2c_l, inv,//mov_c2r_l,  inv,  mov_r2c_l, inv, // mov_c2r_l, inv,  mov_r2c_l, inv,
