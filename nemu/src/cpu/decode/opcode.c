...
instr_func opcode_entry[256] = {
    ...
    /* 0x50 - 0x53*/ __ref___ref_push_r_v, __ref_push_r_v, __ref_push_r_v, __ref_push_r_v,
    ...
    /* 0x68 - 0x6b*/ __ref___ref_push_i_v, imul_irm2r_v, __ref___ref_push_i_b, imul_i8rm2r_v,
