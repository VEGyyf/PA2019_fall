...
instr_func opcode_entry[256] = {
    ...
    /* 0xe8 - 0xeb*/ __ref_call_near,   __ref___ref_jmp_near,   __ref___ref_jmp_far_imm,   __ref___ref_jmp_short,
...
instr_func group_1_b_entry[8] =
    { __ref_add_i2rm_b,  or_i2rm_b,  adc_i2rm_b,  sbb_i2rm_b,  and_i2rm_b,  __ref_sub_i2rm_b,  xor_i2rm_b,  __ref_cmp_i2rm_b};

/* 0x81 */
instr_func group_1_v_entry[8] =
    {__ref_add_i2rm_v, or_i2rm_v, adc_i2rm_v, sbb_i2rm_v, and_i2rm_v, __ref_sub_i2rm_v, xor_i2rm_v, __ref_cmp_i2rm_v};

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {__ref_add_i2rm_bv, or_i2rm_bv, adc_i2rm_bv, sbb_i2rm_bv, and_i2rm_bv, __ref_sub_i2rm_bv, xor_i2rm_bv, __ref_cmp_i2rm_bv};
...
instr_func group_5_indirect_entry[8] =
    {  __ref_inc_rm_v, dec_rm_v, inv, inv, inv, inv, __ref_push_rm_v, inv};
...
instr_func group_x87_d8_entry[8] =
    {x87_f__ref_adds, x87_fmuls, inv, inv, x87_f__ref_subs, inv, x87_fdivs, inv};
...
instr_func group_x87_dc_entry[8] =
    {x87_f__ref_addlx, x87_fmullx, inv, inv, inv, inv, inv, inv};
...
instr_func group_x87_de_entry[8] =
    {x87_f__ref_addx, inv, inv, inv, inv, inv, inv, inv};
