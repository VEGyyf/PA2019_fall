...
instr_func opcode_entry[256] = {
    ...
    /* 0x8c - 0x8f*/ inv, lea, inv, inv,//mov_rm2s_w,
...
instr_func group_3_v_entry[8] =
    {test_i2rm_v, inv, __ref_not_rm_v, inv, mul_rm2a_v, imul_rm2a_v, div_rm2a_v, idiv_rm2a_v};//test_i2rm_v, inv, not_rm_v, neg_rm_v, mul_rm2a_v, imul_rm2a_v, div_rm2a_v, idiv_rm2a_v
