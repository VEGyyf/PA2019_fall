...
instr_func opcode_entry[256] = {
    ...
    /* 0x10 - 0x13*/ add_r2rm_b, add_r2rm_v, add_rm2r_b, add_rm2r_v,
    /* 0x14 - 0x17*/ add_i2a_b, add_i2a_v, inv, inv,
...
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, __ref_or_i2rm_bv, add_i2rm_bv, __ref_sbb_i2rm_bv,  __ref_and_i2rm_bv, __ref_sub_i2rm_bv, __ref_xor_i2rm_bv, cmp_i2rm_bv};
